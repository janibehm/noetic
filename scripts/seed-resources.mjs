...
const doc = {
  ...
  blocks: [
    ...
    },
    {
      ...
      headingLevel: "h2",
      items: [
        { _key: "prompt-anatomy", category: "Prompt Guides", title: "Anatomy of a reliable prompt", href: "#", auroraTone: "default" },
        { _key: "batch-pipeline", category: "Tutorials", title: "Your first batch pipeline", href: "#", imageUrl: photo("1635776062127-d379bfcba9f8") },
        { _key: "composition-rules", category: "AI Art", title: "Composition rules the model loves", href: "#", auroraTone: "warm" },
        { _key: "ad-variants", category: "Marketing", title: "50 ad variants from one brief", href: "#", auroraTone: "cool" },
        { _key: "product-shots", category: "E-commerce", title: "Studio product shots, no studio", href: "#", imageUrl: photo("1523275335684-37898b6baf30") },
        { _key: "vantage-case", category: "Case Studies", title: "How Vantage cut creative time 70%", href: "#", auroraTone: "default" },
        { _key: "reproducible-seeds", category: "Research", title: "Why seeds make results reproducible", href: "#", imageUrl: photo("1620712943543-bcc4688e7485") },
        { _key: "image-3", category: "Product Updates", title: "Introducing noetic-image-3", href: "#", auroraTone: "cool" },
        { _key: "outpainting-wide", category: "Tutorials", title: "Outpainting for wide formats", href: "#", auroraTone: "warm" },
      ],
    },
    {
      _key: "api",
